...
const root='content/customer-experience-rebuild/r12r4b/smr-r2/audit';
const baseline=read(`${root}/smr-r2-current-baseline-v1.json`),failures=read(`${root}/smr-r2-report-failure-registry-v1.json`),sections=read(`${root}/smr-r2-section-duplication-matrix-v1.json`),layout=read(`${root}/smr-r2-layout-gap-matrix-v1.json`);
const oldResults=read('content/customer-experience-rebuild/r12r4b/smr/review/smr-human-review-results-v1.json'),oldAdmission=read('content/customer-experience-rebuild/r12r4b/smr/admission/smr-production-admission-v1.json');
