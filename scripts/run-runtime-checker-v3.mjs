...
const registry = await read('content/governance/runtime-checker-governance/registries/runtime-checker-alias-registry-v3.json');
...
if (input.startsWith('--group=')) {
  ...
  const groups = await read('content/governance/runtime-checker-governance/registries/runtime-checker-group-registry-v1.json');
