...
const figs=json('content/registry/figures.json'),parts=json('content/registry/successors/eight-volume-v1/parts.json'),audit=json('content/web-production/audits/wpr-figure-ownership-drift-audit-v1.json');
