...
console.log('✓ ECR Mandala brand/scoped-CSS gate passed: the registered ECR method icon remains authoritative and the specialist stylesheet does not create a global design layer.');
