...
assert.equal(baseline.baselineCommit,'92b30b95cf2f70af4ed2ee8e41401764b06fa8b5');
assert.equal(baseline.sourceMirror.libraryFile,'read(1).zip');
...
console.log(`✓ CX-R0 current-authority reconciliation passed at 92b30b9: ${surfaces.summary.customerHtmlCount} customer HTML surfaces, ${css.summary.customerConsumedStylesheets} consumed stylesheets, ${js.summary.customerConsumedScripts} consumed scripts.`);
