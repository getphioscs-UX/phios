...
import {SMR_R2_CONTRADICTION_RULES} from '../functions/single-method-reading-r2/smr-r2-w6-w8-rules.js';

const contract=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr-r2/contracts/smr-r2-contradiction-preservation-contract-v1.json','utf8'));
const registry=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr-r2/registries/smr-r2-contradiction-state-registry-v1.json','utf8'));
