...
export function validatePreview(preview){
 ...
 assert.deepEqual(preview.r2_buckets,[{binding:'BOOKS',bucket_name:'phios-private-books-sandbox'}]);
...
assert.deepEqual(config.r2_buckets,[{binding:'MANUSCRIPTS',bucket_name:'phios-private-manuscripts'}]);assert.deepEqual(config.ai,{binding:'AI'});
