...
assert.equal(manifest.masterWork.a1Status,'COMPLETE'); assert.ok(['READY_NOT_STARTED','COMPLETE'].includes(manifest.masterWork.a2Status)); assert.ok([false,true].includes(manifest.publication.bookIVAdmitted));
...
console.log(`✓ Book IV PJA Wave 1 remains rebound to A1 final nodes; later A5/A6 progression may advance without changing A1 canonical meaning. Article publication remains separately gated.`);
