...
const layers=json('content/civilization-atlas/atlas-layers-v1.json'); assert.equal(layers.explorerLayers.find(x=>x.layerId==='comparison')?.customerEnabled,true);
// Successor-aware: W9–W11 activation is legal after W7 is frozen.
...
console.log('  Six stable comparison families remain active; successor W9–W11 activation is allowed without changing W7 authority.');
