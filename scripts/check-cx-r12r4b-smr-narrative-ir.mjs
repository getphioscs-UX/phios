...
const contract=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr/contracts/customer-reading-narrative-ir-v1.json','utf8'));
const schema=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr/contracts/customer-reading-narrative-ir-v1.schema.json','utf8'));
