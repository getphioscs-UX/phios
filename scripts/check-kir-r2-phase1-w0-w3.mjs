...
assert.equal(w2.totals.canonicalNodes,348);
assert.equal(w3.profileCount,348);
assert.deepEqual(w3.bookCounts,{'BOOK-1':65,'BOOK-2':180,'BOOK-3':103});
...
console.log('  Semantic Retrieval Profiles: 348/348 (65 + 180 + 103).');
