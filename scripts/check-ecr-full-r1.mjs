...
console.log(`PASS ECR-FULL-R1: 64 structural cases / ${results.length} bilingual executions; free/paid payload isolation, shared lineage, PHI Card/Mandala consistency, draft Commerce. Human acceptance ${ECR_FULL_REPORT_ADMISSION.humanReview}.`);
