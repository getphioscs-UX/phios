...
for(const phrase of ['716 existing Canonical Node Authority','2 KAU-R5 Human-accepted admissions','0 silent deletion','473 publication ownership records','323 upstream Canonical admission review candidates','W1B is Human approved; W1C Human Acceptance remains pending']) assert(audit.includes(phrase));
...
console.log('  323 upstream admission recommendations are accounted for; W1D has accepted 0 and created 0 new Canonical identities.');
console.log('  W1B is Human approved; W1C remains pending, and nodes.json plus active Blueprint authority were not mutated.');
