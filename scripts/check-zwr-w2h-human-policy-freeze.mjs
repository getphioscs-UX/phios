...
const ev=j('content/professional/zi-wei-runtime/evidence/zi-wei-human-freeze-evidence-v1.json');
const acc=j('content/professional/zi-wei-runtime/acceptance/zwr-w2h-human-policy-freeze-acceptance-v1.json');
