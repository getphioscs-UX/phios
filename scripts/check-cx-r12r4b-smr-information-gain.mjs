...
import {SMR_R2_SECTION_RULES} from '../functions/single-method-reading/smr-w6-w8-rules.js';

const contract=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr/contracts/smr-section-information-gain-contract-v1.json','utf8'));
const registry=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr/registries/smr-section-information-gain-registry-v1.json','utf8'));
