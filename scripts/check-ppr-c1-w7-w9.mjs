...
const specialistRenderer=read('assets/customer-ui/js/specialists/bazi/product-renderer.js');assert.match(specialistRenderer,/renderBaziProduct/);
const client=read('assets/customer-ui/js/surfaces/personal-reality.js');assert.match(client,/renderProductRoute/);assert.match(client,/collectMethodInputExtensions/);assert.doesNotMatch(client,/seedBaziTargetContext/);
