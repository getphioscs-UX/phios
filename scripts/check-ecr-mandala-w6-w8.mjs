...
assert.match(productRendererSource,/coordinateStoryHtml=mandala\?renderCoordinateStoryVisual\(mandala\):''/);
...
assert.match(coordinateStorySource,/data-ecr-capability-network/);
assert.match(coordinateStorySource,/View all 16 grammar-question positions|查看全部 16 个运行位置/);
assert.match(coordinateStorySource,/Explore the full question-capability map|查看完整问题—能力图/);
...
assert.match(storyHtml,/Selected Coordinate Spine|Selected Coordinate Spine/i);
