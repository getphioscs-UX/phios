...
console.log(`  ${registryPresentProductionDeferredCount} non-Preface identities have no Editorial Production Readiness record and remain production-deferred; universal fixtures cover P1–P14 and Books I–III.`);
