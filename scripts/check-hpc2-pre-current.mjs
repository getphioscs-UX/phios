...
assert.equal(w4Contract.predecessorAuthority.w3FreezeSha256, digest('content/web/homepage/hpc2/freeze/hpc2-w3-one-reality-composition-freeze-v1.json'));
assert.equal(w4Contract.figureAsset.assetCode, 'FIG-055');
assert.equal(w4Contract.figureAsset.existingResolverReused, true);
assert.equal(w4Contract.figureAsset.secondResolverCreated, false);
