...
export const RESEARCH='content/customer-experience-rebuild/r12r4b/smr/history/v1/enrichment/w0-w2';
export function measureDepth(root=process.cwd()){
 const input='content/customer-experience-rebuild/r12r4b/smr/history/v1/review/smr-human-review-cases-v1.json';
