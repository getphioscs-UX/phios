...
const OLD=`${ROOT}/smr/history/v1`;
const OUT=`${ROOT}/smr/audit`;
...
write(`${OUT}/smr-current-baseline-v1.json`,currentBaseline);
write(`${OUT}/smr-report-failure-registry-v1.json`,failureRegistry);
write(`${OUT}/smr-section-duplication-matrix-v1.json`,sectionMatrix);
write(`${OUT}/smr-layout-gap-matrix-v1.json`,layoutGap);
