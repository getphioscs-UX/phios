...
const r=read('content/customer-experience-rebuild/r12r4b/smr/review/smr-w17-five-benchmark-human-review-results-v1.json');
const a=read('content/customer-experience-rebuild/r12r4b/smr/admission/smr-w17-five-benchmark-human-admission-v1.json');
