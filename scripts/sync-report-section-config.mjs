...
const names={registry:'bazi-section-registry',familyRegistry:'report-page-families',visualAssets:'bazi-visual-assets',visualModules:'bazi-publication-visual-modules'};
