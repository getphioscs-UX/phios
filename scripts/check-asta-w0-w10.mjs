...
const request=(canonicalInput=input,id='ASTA-W10')=>({schemaVersion:'PHI-OS-MCD-METHOD-EXECUTION-REQUEST-v1.0.0',methodCode:'ASTROLOGY',methodVersion:'0.1.0',capability:'CALCULATION',purposeCode:'ASTA_W0_W10_CHECK',canonicalInput,executionParameters:{},consentRecordId:'ASTA-FIXTURE-CONSENT',requestId:id});
...
console.log('  AST remains Limited: meaning, reading and current public frontend promotion are intentionally deferred to ASTA-W11–W24.');
