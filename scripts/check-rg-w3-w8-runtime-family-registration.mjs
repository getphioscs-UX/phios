...
const pkg=await read('package.json'); const prior=await read('content/governance/runtime-checker-governance/registries/runtime-checker-alias-registry-v2.json'); const reg=await read('content/governance/runtime-checker-governance/registries/runtime-checker-alias-registry-v3.json'); assert.equal(pkg.scripts['check:runtime'],'node scripts/run-runtime-checker-v2.mjs');
