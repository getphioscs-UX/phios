...
const nodeCount = registry.nodes.length;
assert.equal(c1.entries.length, nodeCount); assert.equal(c2.entries.length, nodeCount); assert.equal(index.entries.length, nodeCount);
