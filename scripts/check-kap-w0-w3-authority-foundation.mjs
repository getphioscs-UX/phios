...
assert.equal(pkg.scripts['check:kap-foundation'],'node scripts/check-kap-w0-w3-authority-foundation.mjs'); assert.equal(pkg.scripts['check:kap'],'npm run check:kap-foundation');
console.log('✓ KAP Phase 1 W0-W3 Authority Foundation accepted and frozen.');
console.log('  Knowledge / Answer / Publication / Reality Reading boundaries are frozen; no later KAP, MCD, AI, Guided Reading or client-surface runtime is activated.');
