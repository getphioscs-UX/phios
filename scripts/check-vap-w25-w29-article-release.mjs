...
assert.equal(candidate.status, 'BLOCKED_STALE_PUBLISHED_FIGURE_LINEAGE');
...
assert(candidate.blockers.includes('PUBLISHED_FIGURE_MEANING_LINEAGE_STALE'));
...
console.log('✓ Release remains fail-closed because the current Published Figure belongs to the superseded fixture-bound CAB lineage.');
