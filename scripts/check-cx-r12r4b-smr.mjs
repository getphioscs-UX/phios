...
if(requested==='all'){for(const name of gates.keys())await run(name);console.log('  64/64 machine reports passed. 48/48 human reports are materialized and truthfully remain pending; production cutover stays blocked.')}else await run(requested);
