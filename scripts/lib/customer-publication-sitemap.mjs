...
export const manifests=['content/knowledge/public/visual-article-release.json','content/knowledge/public/abl-bilingual-release.json','content/knowledge/public/successors/book4-publication-v1/visual-article-release.json','content/knowledge/public/successors/book5-publication-v1/visual-article-release.json'];
export const staticRoutes=['/','/explore/','/about/','/knowledge/','/knowledge/ask/','/knowledge/concepts/','/articles/','/figures/','/books/','/books/reality-formation/','/books/reality-runtime/','/books/reality-continuity/','/books/reality-expansion/','/books/reality-differentiation/','/books/reality-configuration/','/books/reality-observation/','/books/reality-navigation/','/reality/','/perspectives/','/perspectives/personal/','/perspectives/profile/','/perspectives/relationship/','/perspectives/iching/','/perspectives/tarot/','/professional/','/professional/financial/','/professional/services/','/professional/authority/','/search/'];
