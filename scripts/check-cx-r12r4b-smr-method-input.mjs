...
import {adaptBaziProductionInput} from '../functions/single-method-reading/bazi-production-adapter.js';
import {adaptZiWeiProductionInput} from '../functions/single-method-reading/ziwei-production-adapter.js';
import {adaptNumerologyProductionInput} from '../functions/single-method-reading/numerology-production-adapter.js';
import {adaptEcrProductionInput} from '../functions/single-method-reading/ecr-production-adapter.js';
const contract=JSON.parse(fs.readFileSync('content/customer-experience-rebuild/r12r4b/smr/contracts/smr-method-production-input-contract-v1.json','utf8'));
