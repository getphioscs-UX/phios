...
assert(pkg.scripts.check.includes('npm run check:ksar-r8'));
assert(pkg.scripts['check:knowledge-access'].includes('npm run check:ksar-r8'));
...
console.log('  KSAR-R1～R8 Production Freeze is complete through successor evidence.');
