...
assert.equal(successor.remoteEvidenceBoundary.visualHumanReviewPromoted, false);
assert.equal(successor.remoteEvidenceBoundary.actualConsumerPromoted, false);
