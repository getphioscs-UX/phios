...
const currentSuccessor = json('content/knowledge/migrations/book-w1f/wpr-book-w1-current-successor-v4.json');
...
assert.equal(currentSuccessor.status, 'BOOK_W1F_CURRENT_WPR_CHECKER_SUCCESSOR_V4_ACTIVE_POC_A_PUBLIC_ASSET_VERIFICATION_V3_PRESERVED');
assert.equal(currentSuccessor.predecessorCurrentSuccessor.path, 'content/knowledge/migrations/book-w1f/wpr-book-w1-current-successor-v3.json');
assert.equal(currentSuccessor.predecessorCurrentSuccessor.sha256, sha256('content/knowledge/migrations/book-w1f/wpr-book-w1-current-successor-v3.json'));
...
assert.equal(publicAssetVerificationSuccessor.publicAssetRegistry.currentSha256, sha256('content/registry/public-assets.json'));
assert.equal(publicAssetVerificationSuccessor.remoteVerificationAdvancement.targetCount, 10);
assert.equal(currentSuccessor.publicAssets.governancePath, 'content/knowledge/migrations/book-w1e/book-w1e-poc-a-public-asset-verification-successor-v1.json');
