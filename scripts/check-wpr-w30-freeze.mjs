...
const RECONCILIATION = 'docs/wpr/reconciliation/wpr-w30-post-freeze-checker-reconciliation-v1.json';
...
assert.equal(reconciliation.reconciliationCode, 'PHI-OS-WPR-W30-POST-FREEZE-CHECKER-RECONCILIATION-v1');
