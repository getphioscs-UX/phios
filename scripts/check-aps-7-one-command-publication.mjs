...
console.log('✓ APS-7 One-command Publication passed.');
...
async function validatePublishedState(temp, result, publishCount) {
  ...
  assert.equal(authority.recordCount, 2 + publishCount, 'Historical two PKA records plus APS-7 publish outcomes expected.');
