...
assert.match(finalClient,/data-cx-method-disclosure/);
assert.match(finalClient,/Open full method reading/);assert.match(finalClient,/Profile & Assessment/);assert.match(finalClient,/Relationship/);assert.match(finalClient,/NON_CONVERGENCE/);assert.match(finalClient,/window\.print\(\)/);assert.match(css,/@media print/);assert.match(css,/cx-final-reading-nav/);
