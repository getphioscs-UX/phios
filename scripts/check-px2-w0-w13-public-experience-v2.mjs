...
const visual=read('assets/js/public-v2/unified-public-visual-resolver.js');assert.match(visual,/current-client-visual-registry\.json/);assert.ok(!/client-visual-asset-registry-v1\.[0-9]+\.json/.test(visual));
