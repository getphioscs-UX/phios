...
if(await exists(P1_DELETE)){
  ...
  if(p1.status==='PHYSICAL_LEGACY_PRESENTATION_DELETE_COMPLETE'){
    ...
    console.log('✓ M3C-W8 Memory historical customer presentation retired after P1 browser acceptance; runtime evidence remains and canonical My Reality now owns the customer surface.');
    process.exit(0);
  }
}
