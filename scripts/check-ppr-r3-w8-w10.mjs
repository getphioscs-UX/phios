...
const freeze=j(`${base}/authority/ppr-r3-w10-successor-freeze-v1.json`);const {r4}=assertPprC1CurrentSuccessor();assertPprR4AstInputSuccessorIntegrity();
...
for(const [p,d] of Object.entries(freeze.successorFiles)){
  ...
  assertPprR3GovernedPath(p,d,'PPR-R3 W10 successor file');
}
