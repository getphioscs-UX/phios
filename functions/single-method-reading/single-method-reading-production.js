...
export const SMR_PRODUCTION_ADMISSION=freeze({
  schemaVersion:'PHI-OS-SMR-PRODUCTION-ADMISSION-v2.0.0',
...
export async function maybeBuildProductionSingleMethodReading({methodResult,customerIntent=null,locale='en'}={}){
  ...
  return freeze({
    schemaVersion:'PHI-OS-SINGLE-METHOD-READING-PRODUCTION-v2.0.0',
    ...
    governance:freeze({
      productionAdmission:'SMR_V2_W17_5_OF_5_PLUS_W18_40_OF_40_PLUS_W19_20_OF_20',
