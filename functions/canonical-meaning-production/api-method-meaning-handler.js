/** CMP Production Meaning API. Consumes an already accepted MCD-5 CanonicalMethodProjection; never recalculates a Method. */
...
function validateProjection(projection){
 if(!projection||projection.schemaVersion!=='PHI-OS-CANONICAL-METHOD-PROJECTION-v1.0.0')throw Object.assign(new Error('CMP_CANONICAL_PROJECTION_REQUIRED'),{code:'CMP_CANONICAL_PROJECTION_REQUIRED'});
