import { resolveCanonicalMeaningItems, sha256Canonical } from './meaning-resolver-production.js';
...
export async function buildCanonicalMeaningProductionBundle({ projection, admissionRegistry, mappingRegistry, activationRegistry = null, mode = 'foundation_validation' }) {
  const resolved = await resolveCanonicalMeaningItems({ projection, admissionRegistry, mappingRegistry, activationRegistry, mode });
