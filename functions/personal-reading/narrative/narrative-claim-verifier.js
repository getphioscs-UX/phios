...
const ALWAYS_PROHIBITED=new Set(['DIAGNOSIS','GUARANTEED_FUTURE_EVENT','PARTNER_HIDDEN_STATE_INFERENCE','COMPATIBILITY_PERCENTAGE','DESTINY_OR_SOULMATE_VERDICT','STAY_LEAVE_DIRECTIVE','GUARANTEED_RELATIONSHIP_OUTCOME','SCIENTIFIC_VALIDATION_TRANSFER','IQ','PERCENTILE','COGNITIVE_DIAGNOSIS']);
...
function classify(claim,brief,known){
  const explicit=clean(claim.claimClass).toUpperCase();const prohibited=textProhibition(claim.text,brief)||sourceClassDrift(claim);
