...
export const COMPOSITION_VERSION='BAZI_EDITORIAL_COMPOSITION_V2';
export const VERIFIER_VERSION='BAZI_SEMANTIC_VERIFIER_V2';
export const EDITORIAL_VERSION='BAZI_EDITORIAL_VALIDATOR_V2';
export const COMPOSITION_POLICY_REVISION='BAZI_LICENSED_EVIDENCE_ADAPTIVE_V4';
