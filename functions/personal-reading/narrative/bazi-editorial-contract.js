...
export const COMPOSITION_POLICY_REVISION='BAZI_EDITORIAL_POLICY_R2';
...
export async function buildSectionEvidencePack({interpretation,locale,sectionKey,relatedInterpretations=[]}){
 ...
 facts.push({id:'policy:BOUNDED_SYMBOLIC_READING',text:'This is a conditional symbolic reading. It does not establish observed customer events, measured personality, medical diagnoses, guaranteed income, relationships or professions. Experience can differ from the interpretation.',sourceRefs:['docs/guided-report-successor-r2/addendum-d.md'],claimScope:'BOUNDARY_ONLY_NOT_PERSONAL_EVIDENCE'});
 ...
 pack.compositionPolicyRevision=COMPOSITION_POLICY_REVISION;
