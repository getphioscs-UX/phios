...
export async function buildAstCustomerWorkspaceCandidate({canonicalProjection,rawIntent='',explicitIntentProfileId=null,locale='en',targetContext=null,consentRecordId='ENGINEERING-CANDIDATE',sourceMainCommit='343773fd6fb61fbf1b37aa861537d7e8f091ec24',astronomyModuleLoader}={}){
 ...
 const workspace=buildAstInteractiveWorkspace({canonicalProjection,reading,intentResolution,languageRegistry:AST_READER_LANGUAGE_REGISTRY,cutoverGate:EFFECTIVE_AST_CUTOVER_GATE,temporalIR});
 return freeze({schemaVersion:'PHI-OS-AST-CUSTOMER-WORKSPACE-CANDIDATE-BUNDLE-v1.0.0',intentResolution,professionalSemanticProjection,synthesis,temporalIR,astt,reading,workspace,cutoverGate:EFFECTIVE_AST_CUTOVER_GATE});
}
