...
const SUPPORTED_METHODS=Object.freeze(['AST','BZR','NUM','ZWR']);
...
export function resolveCustomerCompositionAdmission({
  ...
  const source=customerCompositionAdmissionFor(methodId);
  ...
  return freeze({
    ...
    admitted,
    admissionId:admitted?`CX-R12R3B-PASS2B-${methodId}-ADMISSION`:null,
    admissionRef:admitted?`${CX_R12R3B_COMPOSITION_ADMISSION_CONSUMER.sourceAuthorityRef}#methodAdmission/${methodId}`:null,
    ...
    authority:{
      sourceAuthorityRef:CX_R12R3B_COMPOSITION_ADMISSION_CONSUMER.sourceAuthorityRef,
      sourceAuthoritySha256:CX_R12R3B_COMPOSITION_ADMISSION_CONSUMER.sourceAuthoritySha256,
