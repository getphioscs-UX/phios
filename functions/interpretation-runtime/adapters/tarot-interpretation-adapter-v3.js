...
export function bindTarotProductInterpretationProjections(projections,authorities={}){
  if(!Array.isArray(projections)||![1,3].includes(projections.length))throw new TypeError('TAROT_ONE_OR_THREE_CARD_PROJECTIONS_REQUIRED');projections.forEach(assertProjection);assertAuthorities(authorities);
