 ...
 */
import {bindTarotProductInterpretationProjections} from './adapters/tarot-interpretation-adapter-v4.js';

export const TAROT_READING_IR_VERSION='2.1.0';
...
const POSITION_FOCUS=Object.freeze({
  WHAT_DESERVES_ATTENTION:'ATTENTION',BACKGROUND:'ATTENTION',CURRENT_SITUATION:'ATTENTION',NEXT_CONSIDERATION:'NEXT_OBSERVATION',
  CURRENT_POSITION:'ATTENTION',PATH_A_NEED:'ATTENTION',PATH_B_NEED:'ATTENTION',PATH_A_DIRECTION:'NEXT_OBSERVATION',PATH_B_DIRECTION:'NEXT_OBSERVATION',
  MY_POSITION:'ATTENTION',RELATIONSHIP_STRUCTURE:'ATTENTION',OTHER_VISIBLE_POSITION:'ATTENTION',EMERGING_DIRECTION:'NEXT_OBSERVATION',DISCUSSION_POINT:'NEXT_OBSERVATION',
  CURRENT_STATE:'ATTENTION',TIMING:'ATTENTION',INFLUENCES:'TENSION',SUCCESS_CONDITIONS:'ATTENTION',DEVELOPMENT_DIRECTION:'NEXT_OBSERVATION',
  CURRENT_REALITY:'ATTENTION',MOST_VISIBLE:'ATTENTION',POSSIBLE_MISREAD:'TENSION',DESERVES_ATTENTION:'ATTENTION',REALITY_CHECK:'NEXT_OBSERVATION',NEXT_OBSERVATION:'NEXT_OBSERVATION',
  EMERGING_CHANGE:'NEXT_OBSERVATION',POSSIBLE_RESPONSE:'NEXT_OBSERVATION',ENVIRONMENT:'ATTENTION',CORE_OBSTACLE:'TENSION',CONTINUATION_DIRECTION:'NEXT_OBSERVATION',
  CORE_SITUATION:'ATTENTION',PRIMARY_TENSION:'TENSION',CONSCIOUS_VIEW:'ATTENTION',DEEP_DRIVER:'TENSION',FORMED_BACKGROUND:'ATTENTION',EMERGING_NEXT:'NEXT_OBSERVATION',YOUR_POSITION:'ATTENTION',HOPES_CONCERNS:'TENSION'
});
