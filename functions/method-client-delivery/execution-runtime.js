...
export async function executeMcd4Request(request){
  ...
  else if(decision.pluginCode==='AST') execution=Object.freeze({coreExecutionPerformed:false,coreHistoricalExecutionMode:'validation',executedStages:Object.freeze(['MPA_EVALUATION','CANONICAL_INPUT_EVALUATION','AST_ADAPTER_BINDING_RESOLUTION']),deferredStages:Object.freeze(['AST_ASTRONOMY_CONTEXT','AST_PLANET_EPHEMERIS_CORE_10']),reasonCodes:Object.freeze(['AST_GOVERNED_ASTRONOMY_ENGINE_ADAPTER_NOT_MATERIALIZED']),coreResults:Object.freeze([])});
  else if(decision.pluginCode==='BZR') execution=Object.freeze({coreExecutionPerformed:false,coreHistoricalExecutionMode:'validation',executedStages:Object.freeze(['MPA_EVALUATION','CANONICAL_INPUT_EVALUATION','BZR_ADAPTER_BINDING_RESOLUTION']),deferredStages:Object.freeze(['BZR_SOLAR_CALENDAR','BZR_PILLARS','BZR_LUCK_CYCLE']),reasonCodes:Object.freeze(['BZR_GOVERNED_SOLAR_TERM_RUNTIME_ADAPTER_NOT_MATERIALIZED']),coreResults:Object.freeze([])});
