...
import { TAROT_METHOD_CODE, TAROT_PLUGIN_CODE, TAROT_RUNTIME_VERSION, validateTarotEvidenceBundle } from './tarot-selection-runtime-v2.js';

export const TAROT_RUNTIME_CODE = 'TAROT_RUNTIME';
export const TAROT_ALGORITHM_CODE = 'TAROT_CARD_STRUCTURAL_LOOKUP';
export const TAROT_ALGORITHM_VERSION = '2.0.0';
