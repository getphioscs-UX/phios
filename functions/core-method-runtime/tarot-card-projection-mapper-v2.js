...
import { TAROT_ALGORITHM_CODE, TAROT_RUNTIME_CODE } from './tarot-runtime-v2.js';
import { TAROT_METHOD_CODE, TAROT_PLUGIN_CODE } from './tarot-selection-runtime-v2.js';

export const TAROT_CARD_MAPPER_CODE='TAROT_CARD_MAPPER';
export const TAROT_CARD_MAPPER_VERSION='2.0.0';
...
export function createTarotCardProjector() {
  ...
  return Object.freeze({
    ...
    async projectSpread({calculationResults,projectionVersion='1.0.0'}={}) {
      if (!Array.isArray(calculationResults) || ![1,3,5,6,7,10].includes(calculationResults.length)) throw new TypeError('TAROT_SPREAD_CALCULATION_RESULTS_REQUIRED');
