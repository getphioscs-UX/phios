...
import {
  scoreOriginalReasoningTaskBank, renderReasoningPerformance,
...
export async function onRequestPost(context){
  ...
  try{
    let signals=[],rawResult=null,reasoningView=null,careerExploration=null;
    ...
    return json({ok:true,mode,view,reasoningView,careerExploration,governance:{automaticPersistence:false,rawResultStored:false,rawAnswersReturned:false,sourceClassPreserved:true,customerPublishable:exec.customerPublishable,preview:exec.preview}});
  }catch(error){return errorResponse(error)}
}
