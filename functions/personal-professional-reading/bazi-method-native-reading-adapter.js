...
function baziEnvelope({report,readingIR,publicationDecision,temporalProjection,temporalState}){
 ...
 return buildMethodNativeCustomerReading({
  ...
  governance:{
   ...
   natalProjectionReused:true,natalRecalculatedForTemporal:false,legacyComposeBzrConsumed:false,professionalStructureSurfaceAuthorized:true,wholeChartFirstIaAuthorized:true,customerSurfaceLanguagePurgeAuthorized:true,professionalReadingIaV2Authorized:true,fiveElementVisualProjectionAuthorized:true,tenGodProfessionalCompositionAuthorized:true,patternProfessionalSurfaceAuthorized:true,threeSchoolProfessionalSurfaceAuthorized:true,temporalExperienceAuthorized:true,customerSafeEvidenceGraphAuthorized:true,realityComparisonRebuildAuthorized:true,pprR3SpecialistNavigationAuthorized:true,
