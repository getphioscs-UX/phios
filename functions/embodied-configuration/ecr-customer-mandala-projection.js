...
export function buildEcrCustomerMandalaProjection(readingIR){
  ...
  return freeze({
    ...
    calculation:freeze({
      engineCode:spec.anchor.engine,
      engineLabel:'Astronomy Engine JS',
      engineVersion:spec.anchor.engineVersion,
      engineLicense:spec.anchor.license,
      referenceFrameCode:spec.zeroPoint.frame,
      referenceFrameLabel:'Geocentric Tropical Ecliptic',
      calculationSpecSchemaVersion:spec.schemaVersion,
      calculationSpecRef:'content/embodied-configuration/ecr-calculation-spec-v1.json',
      inputAuthority:spec.inputAuthority,
      boundaryConvention:spec.zeroPoint.boundaryConvention,
      calculationCreatesCustomerMeaning:false,
      rendererRecalculates:false
    }),
    selected,
