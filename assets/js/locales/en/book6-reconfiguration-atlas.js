...
const book6Atlas = Object.freeze({
  book6Atlas: {
    ui: {
      ...
      runtimeReadout: 'Reality Readout',
      runtimeReadoutLead: 'The canonical Reality Readout Engine is active. It reports the current evidence boundary instead of inventing missing values.',
      runtimeEvidenceGateOpen: 'Current evidence gate not yet satisfied',
      runtimeConfidence: 'Readout confidence',
      runtimeConfidenceUnknown: 'Not yet determinable from admitted evidence',
      runtimeNeeds: 'What is still required',
      runtimeNeedEvidence: 'Admitted current evidence',
      runtimeNeedObservation: 'Governed current observations',
      runtimeNeedMethod: 'Applicable governed projection input',
      runtimeHistoricalContext: 'Historical knowledge already linked',
      runtimeEngineBoundary: 'This is a derived readout, not current measured fact and not a prediction.',
      runtimeLoading: 'Loading governed runtime readout…',
      runtimeUnavailable: 'The runtime readout is temporarily unavailable.',
