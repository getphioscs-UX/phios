const professional = Object.freeze({
  professionalWorkspace: {
    ...
    boundary: 'Professional interpretation is not observed evidence. Restricted external method projections and other External Readers remain interpretation-only.',
    language: 'Language',
    viewsAria: 'Professional Workspace views',
    clientList: 'Client List',
    runtimeView: 'Runtime View',
    humanDesignView: 'Personal Runtime Projection',
    noHumanDesign: 'Personal Runtime Projection is currently unavailable.',
  ...
  externalReaderIntake: {
    ...
    readerHumanDesign: 'Personal Runtime Projection',
    readerBazi: 'BaZi',
    readerZiwei: 'Zi Wei',
    ...
    humanDesignAvailable: 'Personal Runtime Projection remains unavailable until independent authority approval.',
    ...
    humanDesignFields: 'Known Personal Runtime Projection fields',
    hdType: 'Type',
  ...
  professionalAppointments: {
    ...
    services: {
      ...
      human_design_consultation: 'Personal Runtime Projection — unavailable',
      runtime_human_design_consultation: 'Runtime + Personal Runtime Projection — unavailable',
  ...
  financialPublic: {
    ...
    qualificationsCopy: 'Work is assigned within the professional’s verified scope. Matters requiring regulated tax, legal, investment or insurance advice are referred to an appropriately licensed professional.',
    ...
    priceTitle: 'Price',
    priceCopy: 'Price is confirmed before booking according to the selected service, household scope, document volume and review complexity. No product commission determines the fee.',
    comparisonEyebrow: 'Choose the appropriate depth',
    comparisonTitle: 'Financial Service Comparison',
    comparisonLead: 'Each service uses the same evidence, information-date, assumption and professional-boundary rules.',
    comparisonService: 'Service', comparisonUse: 'Primary use',
    services: {
      snapshot: 'Financial Reality Snapshot',
      snapshotCopy: 'A dated overview of household scope, objectives, position and missing evidence.',
      stamina: 'Financial Stamina Analysis',
      staminaCopy: 'A full analysis of cash flow, position, ratios, capacity, hazards and planning readiness.',
      consultation: 'Financial Consultation',
      consultationCopy: 'A professional discussion of evidence, calculations, assumptions and available choices.',
      navigation: 'Financial Navigation Plan',
      navigationCopy: 'A prioritised, product-neutral action plan with alternatives, dependencies and review triggers.',
      followup: 'Implementation Follow-up',
      followupCopy: 'A review of completed actions, changed information, new risks and revised recommendations.',
      annual: 'Annual Runtime Review',
      annualCopy: 'A dated annual comparison of position, objectives, decisions, implementation and next review.'
    },
    boundaryTitle: 'Professional boundary',
    boundary: 'PHI OS Financial Reality Navigation helps organise, analyse and review your current financial position.',
    boundaryDate: 'Calculations and projections depend on the information and assumptions available at the stated report date.',
    boundaryGuarantee: 'They do not guarantee investment, insurance, property or future financial outcomes.',
    book: 'Book Service'
  },
