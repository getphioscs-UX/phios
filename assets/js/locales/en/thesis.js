const thesis = Object.freeze({
  "thesis": {
    ...
    "hero": {
      ...
      "atlas": "Enter the Reality Atlas",
      "begin": "Begin a Reality Journey"
    },
    "route": {
    ...
    "reader": {
      "eyebrow": "Full Research Document",
      "title": "Read the thesis.",
      "open": "Open PDF",
      "download": "Download PDF",
      "fallback": "If the embedded reader does not appear, use “Open PDF” above."
    },
    "footer": {
      "copy": "Reality Navigation Thesis · Research Foundation"
    }
  }
});
