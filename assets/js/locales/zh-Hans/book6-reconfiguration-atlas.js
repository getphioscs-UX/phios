...
const book6Atlas = Object.freeze({
  book6Atlas: {
    ui: {
      ...
      runtimeNeeds: '仍需要补齐',
      runtimeNeedEvidence: '已接纳的当前证据',
      runtimeNeedObservation: '受治理的当前观察资料',
      runtimeNeedMethod: '适用且受治理的投影输入',
      runtimeHistoricalContext: '已经关联的历史知识',
      runtimeEngineBoundary: '这是推导运行读数，不是当前实测事实，也不是预测。',
      runtimeLoading: '正在读取受治理的运行读数……',
      runtimeUnavailable: '运行读数暂时无法取得。',
