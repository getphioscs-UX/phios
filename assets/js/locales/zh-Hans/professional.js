const professional = Object.freeze({
  professionalWorkspace: {
    ...
    boundary: '专业解释不等于观察证据。受限制的外部方法投射及其他外部解释系统始终只属于解释观点。',
    language: '语言',
    viewsAria: '专业工作区视图',
    clientList: '客户列表',
    runtimeView: 'Runtime 查看',
    humanDesignView: '个人运行投射',
    noHumanDesign: '个人运行投射目前不可用。',
  ...
  externalReaderIntake: {
    ...
    displayName: '显示名称',
    humanDesignAvailable: '个人运行投射在独立 authority 批准前保持不可用。',
  ...
  professionalAppointments: {
    ...
    services: {
      ...
      human_design_consultation: '个人运行投射 — 暂不可用',
      runtime_human_design_consultation: '现实运行 + 个人运行投射 — 暂不可用',
