...
export const BOOK_ROUTE_BY_ID = Object.freeze({
  ...
  'book-3': '/books/reality-civilization',
  'book-4': '/books/reality-navigation'
});
...
export async function loadCanonicalBooks() {
  ...
  if (!Array.isArray(registry.books) || registry.architecture !== 'four-volume-15-part') {
...
export async function loadCanonicalParts() {
  ...
  if (!Array.isArray(registry.parts) || registry.architecture !== 'four-volume-15-part') {
