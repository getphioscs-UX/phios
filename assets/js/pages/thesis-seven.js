...
const copy={
 en:{title:'Eight books. One architecture.',copy:'The eight books form the human-readable route through the fifteen-part PHI OS architecture.',books:[
  ...
  ['BOOK VI','Reality Configuration','Contents will be announced.'],
  ['BOOK VII · PART 13','Reality Observation','Reading Science establishes observation, evidence, projection, interpretation and reading governance.'],
  ['BOOK VIII · PARTS 14–15','Reality Navigation','Navigation Science turns reading toward diagnosis, direction, action, outcome and Reality Continuation.']
 ]},
 'zh-Hans':{title:'八册书，一套架构。',copy:'八册书构成 PHI OS 十五部架构面向人的完整阅读路径。',books:[
