...
import {loadTimelineRegistry,loadCaseRegistry} from './civilization-atlas/atlas-data.js';
...
if(root){
  ...
  const data={timeline:null,cases:null}; let loadError=null;
