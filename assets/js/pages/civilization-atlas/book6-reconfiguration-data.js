...
export async function loadBook6AtlasData(){const [registry,cases,windows,snapshots,dossiers,lived,relationships,visuals]=await Promise.all([
...
]);return {registry,cases,windows,snapshots,dossiers,lived,relationships,visuals}}
