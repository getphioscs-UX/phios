...
const ichingCustomerExperience=document.body.dataset.cxSurface==='ICHING_FULL_PRODUCTION'
  ?import('./surfaces/iching-customer-reading.js')
  :Promise.resolve();
initializeCustomerShell().then(async()=>{
  if(document.body.dataset.cxSurface==='ICHING_FULL_PRODUCTION'){
    await ichingCustomerExperience;
